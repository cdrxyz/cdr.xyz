...
export const caseStudy = {
  ...
  description:
    'The new trading app allowed users to buy and sell positions in social trends, and profit by being early.',
  summary: [
    'Blast Trading App was a novel web app which allowed users to buy and sell positions in social trends.',
  ],
  logo,
  image: { src: imageHero },
  date: '2024-02',
  ...
  testimonial: {
    ...
    content: "Honestly, we were a bit desperate when we reached out. They managed to turn the entire app around and fix our broken backend in time for our launch date. We were very impressed, I couldn't recommend them more to anyone in a pinch."
  },
}
...
<Blockquote
  ...
  image={{ src: imageCeo }}
>
  Honestly, we were a bit desperate when we approached Cedar Labs. They managed
  to turn the entire app around and fix our broken backend in time for our
  launch date. We were very impressed, I couldn't recommend them more to anyone
  in a pinch.
</Blockquote>
