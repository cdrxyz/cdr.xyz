...
const team = [
  {
    ...
    people: [
      ...
      },
      {
        ...
        bio: 'Andrew co-founded Cedar Labs after nearly eight years at Block, where he was the top contributor to Misk – the company\'s open-source Kotlin cloud microservices framework — used by over 2,000 applications to power the backends for Cash App and Square. A Linux Foundation certified open-source developer for enterprise and Canada\'s Business Model Competition winner, he now focuses on bringing Fortune 500-grade engineering to the understaffed upstarts who need it most.',
